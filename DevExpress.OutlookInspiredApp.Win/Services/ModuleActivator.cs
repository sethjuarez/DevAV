namespace DevExpress.OutlookInspiredApp.Services {
    ...
    class ReportActivator : IReportActivator {
        ...
        public ReportActivator() {
            ...
            reportTypes.Add(CustomerReportType.SalesSummary, typeof(DevExpress.DevAV.Reports.CustomerSalesSummary));
            reportTypes.Add(CustomerReportType.SalesDetail, typeof(DevExpress.DevAV.Reports.CustomerSalesDetail));
            ...
            reportTypes.Add(SalesReportType.SalesReport, typeof(DevExpress.DevAV.Reports.SalesOrdersSummary));
            reportTypes.Add(SalesReportType.SalesByStore, typeof(DevExpress.DevAV.Reports.SalesAnalysis));
        }
