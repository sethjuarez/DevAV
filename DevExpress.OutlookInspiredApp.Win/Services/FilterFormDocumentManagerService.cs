namespace DevExpress.OutlookInspiredApp.Win {
    ...
    class ViewSettingsDialogDocumentManagerService : DialogDocumentManagerService {
        System.Func<ViewModel.CollectionUIViewModel> collectionUIViewModelAccessor;
        public ViewSettingsDialogDocumentManagerService(System.Func<ViewModel.CollectionUIViewModel> collectionUIViewModel) {
        ...
        class ViewSettingsDialogDocument : DialogDocument {
            public ViewSettingsDialogDocument(ViewSettingsDialogDocumentManagerService owner, Form form, object content)
                ...
                var viewModel = content as ViewModel.ViewSettingsViewModel;
