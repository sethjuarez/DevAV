namespace DevExpress.OutlookInspiredApp.Win.Modules {
    ...
    public partial class CustomersExport : BaseModuleControl {
        ...
        public CustomersExport()
            : base(CreateViewModel<CustomersReportViewModel>) {
            InitializeComponent();
        ...
        XtraReport CreateAndInitializeReport(CustomerReportType reportType) {
            ...
            switch(reportType) {
                ...
                case CustomerReportType.LocationsDirectory:
                    ...
                    break;
                case CustomerReportType.SalesDetail:
                    ((CustomerSalesDetail)report).SetChartData(ViewModel.GetOrderItems(CollectionViewModel.SelectedEntityKey));
                    report.DataSource = ViewModel.GetOrders(CollectionViewModel.SelectedEntityKey);
                    break;
                case CustomerReportType.Profile:
                    report.DataSource = new List<Customer> { CollectionViewModel.SelectedEntity };
                    break;
                case CustomerReportType.SalesSummary:
                    report.DataSource = ViewModel.GetOrderItems(CollectionViewModel.SelectedEntityKey);
                    break;
            }
            return report;
        }
