namespace DevExpress.OutlookInspiredApp.Win.Modules {
    ...
    public partial class Employees : BaseModuleControl, IRibbonModule {
        ...
        protected override void OnInitServices(IServiceContainer serviceContainer) {
            ...
            serviceContainer.RegisterService(new DetailFormDocumentManagerService(ModuleType.EmployeeEditView));
        }
        void BindCommands() {
            //New
        ...
        void InitEditors() {
            colDepartment.ColumnEdit = EditorHelpers.CreateEnumImageComboBox<EmployeeDepartment>(gridControl);
