namespace DevExpress.OutlookInspiredApp.Win.ViewModel {
    ...
    public partial class EmployeeCollectionViewModel : EmployeeCollectionViewModelBase, ISupportMap, ISupportCustomFilters {
        ...
        protected override Employee OnEntityChanged(Guid key) {
            Employee employee = base.OnEntityChanged(key);
            if(employee != null) {
                employee.ResetBindable();
                RaiseEntityChanged(employee);
            }
            return employee;
        }
        ...
        public event EventHandler<EntityEventArgs<Employee>> EntityChanged;
        ...
        void SchedulerMessage(string caption) {
            MessageBoxService.Show(scheduler, caption, System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Information, System.Windows.MessageBoxResult.OK);
        }
        [Command]
        ...
        void RaiseEntityChanged(Employee employee) {
            EventHandler<EntityEventArgs<Employee>> handler = EntityChanged;
            if(handler != null)
                handler(this, new EntityEventArgs<Employee>(employee));
        }
        void RaiseReload() {
